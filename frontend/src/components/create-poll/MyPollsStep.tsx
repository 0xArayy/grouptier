  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.list}>
            ...
            return (
              <div key={poll.id} className={styles.card}>
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setOpenKebab(isMenuOpen ? null : poll.id);
                  }}
                  aria-label="Меню"
                >
                  ⋯
                ...
                <div
                  className={
                    isPublishOpen && publishStage === 'cats' ? styles.cardFooterExpanded : styles.cardFooter
                  }
                >
                  {isPublic ? (
                    <>
                    ...
                    <>
                      ...
                      <div className={styles.publishCatActions}>
                        ...
                        <button type="button" className={styles.publishCancelBtn} onClick={cancelPublish}>
                          ✕
                        </button>
                      </div>
                    </>
                    ...
                    <>
                      ...
                      <div className={styles.publishChoice}>
                        <button
                          ...
                          onClick={() => {
                            cancelPublish();
                            onPublish(poll.id, true, selectedCats);
                          }}
                        >
                          С именем
                        </button>
                        <button
                          ...
                          onClick={() => {
                            cancelPublish();
                            onPublish(poll.id, false, selectedCats);
                          }}
                        >
                          Анонимно
                        </button>
        ...
        <button type="button" className={styles.dashedBtn} onClick={onCreateNew} disabled={busy}>
